...
export class TvComponent implements OnInit {
  ...
  openLg(profile_path:any, pid:any) {
    const modalRef = this.modalService.open(NgbdModalContenttv, {size: 'lg', centered:true, scrollable: true});
    this.pid = pid;
  ...
  fetchData(){
    this.nowPlayingService.getRecommendTv(this.id).subscribe(res=>{
      this.recommend_mv = res;
    })
    this.nowPlayingService.getSimilarTv(this.id).subscribe(res=>{
      this.similar_mv = res;
    })
    this.nowPlayingService.getTvVideo(this.id).subscribe(res=>{
      this.movie_video = res;
    })
    this.nowPlayingService.getTvDetail(this.id).subscribe(res=>{
      this.movie_detail = res;
    })
    this.nowPlayingService.getTvCast(this.id).subscribe(res=>{
      this.movie_cast = res;
    })
    this.nowPlayingService.getTvReview(this.id).subscribe(res=>{
